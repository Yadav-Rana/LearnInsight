    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1
            ...
            style={{ fontFamily: "var(--font-hk-grotesk)", color: "var(--text-primary)" }}
          >
            Subjects
          </h1>
      ...
      {rootSubjects.length === 0 ? (
        ...
        >
          ...
          <h3 className="text-lg font-semibold" style={{ fontFamily: "var(--font-hk-grotesk)", color: "var(--text-primary)" }}>
            No subjects found
          </h3>
  ...
  return (
    ...
    >
      <div className="p-6">
        ...
        <h3 className="mt-4 text-lg font-semibold" style={{ fontFamily: "var(--font-hk-grotesk)", color: "var(--text-primary)" }}>
          {subject.name}
        </h3>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        <div className="flex items-center justify-between p-6" style={{ borderBottom: "1px solid rgba(255, 255, 255, 0.06)" }}>
          <h2 className="text-lg font-semibold" style={{ fontFamily: "var(--font-hk-grotesk)", color: "var(--text-primary)" }}>
            Create Subject
          </h2>
